...
function cargarPregunta(index) {
  ...
  if (objetoPregunta.imagen) {
    document.getElementById("imagenPregunt").src = objetoPregunta.imagen;
    document.getElementById("imagenPregunt").style.display = "";
  } else {
    document.getElementById("imagenPregunt").style.display = "none";
  }
